...
**Last changed in [[2026-09-21]].** That note's `⚡ Changed this cycle` and `✨ New this cycle` sections hold the reasoning for the most recent moves.
...
- `🟡 ASSESS` **AI pacing and industry-led standards body**, direction reversed: the administration has refused to impose domestic pacing and proposed a US-China incident-notification channel instead, so the likely requirement shifts from pre-deployment gating toward post-incident reporting. [[2026-09-14]], updated [[2026-09-17]], reversed [[2026-09-21]]
...
- `⚠️ CAUTION` **Unverified lab capability claims**, "check what the claimant checked against," not just whether the answer verifies internally. The Cyphral Distich refutation is the worked example; TypeSafe AI's Jev, shipped with no paper, no weights and no training data and now carrying a prior-art claim, is the current live instance. [[2026-09-11]], escalated [[2026-09-15]], third instance [[2026-09-21]]
